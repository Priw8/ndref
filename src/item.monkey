...
Class Item Extends Entity
    ...
    Function InitAll: Void()
        ...
        Item.hephItems1.AddLast(ItemType.Chainmail)
        Item.hephItems1.AddLast(ItemType.PlateArmor)
        Item.hephItems1.AddLast(ItemType.ObsidianArmor)
        Item.hephItems1.AddLast(ItemType.KarateGi)
        Item.hephItems1.AddLast(ItemType.GlassArmor)
        Item.hephItems1.AddLast(ItemType.Helm)
        Item.hephItems1.AddLast(ItemType.Hargreaves)
        Item.hephItems1.AddLast(ItemType.HeavyPlate)
        Item.hephItems1.AddLast(ItemType.BlastHelm)
        Item.hephItems1.AddLast(ItemType.Sunglasses)
        Item.hephItems1.AddLast(ItemType.GlassJaw)
        Item.hephItems1.AddLast(ItemType.SpikedEars)
        Item.hephItems1.AddLast(ItemType.QuartzArmor)
        Item.hephItems1.AddLast(ItemType.HeavyGlassArmor)

        Item.hephItems2.AddLast(ItemType.Cheese)
        Item.hephItems2.AddLast(ItemType.BrightTorch)
        Item.hephItems2.AddLast(ItemType.Holster)
        Item.hephItems2.AddLast(ItemType.Drumstick)
        Item.hephItems2.AddLast(ItemType.Pickaxe)
        Item.hephItems2.AddLast(ItemType.CrownOfThorns)
        Item.hephItems2.AddLast(ItemType.ObsidianTorch)
        Item.hephItems2.AddLast(ItemType.WarDrum)
        Item.hephItems2.AddLast(ItemType.LuminousTorch)
        Item.hephItems2.AddLast(ItemType.PackOfHolding)
        Item.hephItems2.AddLast(ItemType.ObsidianShovel)
        Item.hephItems2.AddLast(ItemType.BloodDrum)
        Item.hephItems2.AddLast(ItemType.InfernalTorch)
        Item.hephItems2.AddLast(ItemType.Ham)
        Item.hephItems2.AddLast(ItemType.GlassShovel)
        Item.hephItems2.AddLast(ItemType.HolyWater)
        Item.hephItems2.AddLast(ItemType.GlassTorch)
        Item.hephItems2.AddLast(ItemType.HeartTransplant)
        Item.hephItems2.AddLast(ItemType.TorchOfForesight)
        Item.hephItems2.AddLast(ItemType.Carrot)
        Item.hephItems2.AddLast(ItemType.Cookies)
        Item.hephItems2.AddLast(ItemType.TorchOfStrength)
        Item.hephItems2.AddLast(ItemType.ShovelOfCourage)
        Item.hephItems2.AddLast(ItemType.ShovelOfStrength)
        Item.hephItems2.AddLast(ItemType.CursedPotion)
        Item.hephItems2.AddLast(ItemType.RatFamiliar)
        Item.hephItems2.AddLast(ItemType.DoveFamiliar)
        Item.hephItems2.AddLast(ItemType.ThrowingStars)
        Item.hephItems2.AddLast(ItemType.IceSpiritFamiliar)
        Item.hephItems2.AddLast(ItemType.TorchOfWalls)
        Item.hephItems2.AddLast(ItemType.ShopkeeperFamiliar)
        Item.hephItems2.AddLast(ItemType.ShieldFamiliar)
        Item.hephItems2.AddLast(ItemType.BattleShovel)

        Item.hephItems3.AddLast(ItemType.Spear)
        Item.hephItems3.AddLast(ItemType.Whip)
        Item.hephItems3.AddLast(ItemType.Rapier)
        Item.hephItems3.AddLast(ItemType.Longsword)
        Item.hephItems3.AddLast(ItemType.Flail)
        Item.hephItems3.AddLast(ItemType.CatONineTails)
        Item.hephItems3.AddLast(ItemType.BloodShovel)
        Item.hephItems3.AddLast(ItemType.Rifle)
        Item.hephItems3.AddLast(ItemType.Axe)
        Item.hephItems3.AddLast(ItemType.Harp)
        Item.hephItems3.AddLast(ItemType.Warhammer)
        Item.hephItems3.AddLast(ItemType.Staff)

        Item.merlinItems1.AddLast(ItemType.FreezeEnemiesSpell)
        Item.merlinItems1.AddLast(ItemType.HealSpell)
        Item.merlinItems1.AddLast(ItemType.ShieldSpell)
        Item.merlinItems1.AddLast(ItemType.BombSpell)
        Item.merlinItems1.AddLast(ItemType.TransmuteSpell)

        Item.merlinItems2.AddLast(ItemType.RingOfLuck)
        Item.merlinItems2.AddLast(ItemType.RingOfGold)
        Item.merlinItems2.AddLast(ItemType.RingOfPeace)
        Item.merlinItems2.AddLast(ItemType.RingOfMight)
        Item.merlinItems2.AddLast(ItemType.RingOfCourage)
        Item.merlinItems2.AddLast(ItemType.RingOfWar)
        Item.merlinItems2.AddLast(ItemType.RingOfMana)
        Item.merlinItems2.AddLast(ItemType.RingOfShadows)
        Item.merlinItems2.AddLast(ItemType.RingOfRegeneration)
        Item.merlinItems2.AddLast(ItemType.RingOfProtection)
        Item.merlinItems2.AddLast(ItemType.RingOfShielding)
        Item.merlinItems2.AddLast(ItemType.RingOfPain)
        Item.merlinItems2.AddLast(ItemType.RingOfFrost)
        Item.merlinItems2.AddLast(ItemType.RingOfPiercing)

        Item.merlinItems3.AddLast(ItemType.RichesScroll)
        Item.merlinItems3.AddLast(ItemType.EnchantWeaponScroll)
        Item.merlinItems3.AddLast(ItemType.TransmuteScroll)
        Item.merlinItems3.AddLast(ItemType.FearScroll)
        Item.merlinItems3.AddLast(ItemType.ScrollOfNeed)
        Item.merlinItems3.AddLast(ItemType.EarthquakeScroll)
        Item.merlinItems3.AddLast(ItemType.BootsOfPain)
        Item.merlinItems3.AddLast(ItemType.EarthTome)
        Item.merlinItems3.AddLast(ItemType.FireballTome)
        Item.merlinItems3.AddLast(ItemType.FreezeTome)
        Item.merlinItems3.AddLast(ItemType.ShieldTome)
        Item.merlinItems3.AddLast(ItemType.TransmuteTome)
        Item.merlinItems3.AddLast(ItemType.PulseTome)

        Item.diamondDealerItems1.AddLast(ItemType.Spear)
        Item.diamondDealerItems1.AddLast(ItemType.Spear)
        Item.diamondDealerItems1.AddLast(ItemType.Spear)
        Item.diamondDealerItems1.AddLast(ItemType.Broadsword)
        Item.diamondDealerItems1.AddLast(ItemType.Broadsword)
        Item.diamondDealerItems1.AddLast(ItemType.Rapier)
        Item.diamondDealerItems1.AddLast(ItemType.Rapier)
        Item.diamondDealerItems1.AddLast(ItemType.TitaniumDagger)
        Item.diamondDealerItems1.AddLast(ItemType.ObsidianDagger)
        Item.diamondDealerItems1.AddLast(ItemType.BloodDagger)
        Item.diamondDealerItems1.AddLast(ItemType.GlassDagger)
        Item.diamondDealerItems1.AddLast(ItemType.GoldenSpear)
        Item.diamondDealerItems1.AddLast(ItemType.Bow)
        Item.diamondDealerItems1.AddLast(ItemType.TitaniumBow)
        Item.diamondDealerItems1.AddLast(ItemType.Crossbow)
        Item.diamondDealerItems1.AddLast(ItemType.ObsidianCrossbow)
        Item.diamondDealerItems1.AddLast(ItemType.Longsword)
        Item.diamondDealerItems1.AddLast(ItemType.GlassLongsword)
        Item.diamondDealerItems1.AddLast(ItemType.CatONineTails)
        Item.diamondDealerItems1.AddLast(ItemType.GoldenCat)
        Item.diamondDealerItems1.AddLast(ItemType.Flail)
        Item.diamondDealerItems1.AddLast(ItemType.BloodFlail)
        Item.diamondDealerItems1.AddLast(ItemType.ObsidianRapier)
        Item.diamondDealerItems1.AddLast(ItemType.TitaniumBroadsword)
        Item.diamondDealerItems1.AddLast(ItemType.Whip)
        Item.diamondDealerItems1.AddLast(ItemType.GoldenWhip)
        Item.diamondDealerItems1.AddLast(ItemType.Axe)
        Item.diamondDealerItems1.AddLast(ItemType.Harp)
        Item.diamondDealerItems1.AddLast(ItemType.Warhammer)
        Item.diamondDealerItems1.AddLast(ItemType.Staff)
        Item.diamondDealerItems1.AddLast(ItemType.Cutlass)
        Item.diamondDealerItems1.AddLast(ItemType.TitaniumCutlass)

        Item.diamondDealerItems2.AddLast(ItemType.Apple)
        Item.diamondDealerItems2.AddLast(ItemType.Apple)
        Item.diamondDealerItems2.AddLast(ItemType.Cheese)
        Item.diamondDealerItems2.AddLast(ItemType.Cheese)
        Item.diamondDealerItems2.AddLast(ItemType.Drumstick)
        Item.diamondDealerItems2.AddLast(ItemType.Ham)
        Item.diamondDealerItems2.AddLast(ItemType.HolyWater)
        Item.diamondDealerItems2.AddLast(ItemType.Carrot)
        Item.diamondDealerItems2.AddLast(ItemType.Carrot)
        Item.diamondDealerItems2.AddLast(ItemType.Cookies)
        Item.diamondDealerItems2.AddLast(ItemType.CursedPotion)
        Item.diamondDealerItems2.AddLast(ItemType.ThrowingStars)

        Item.diamondDealerItems3.AddLast(ItemType.LeatherArmor)
        Item.diamondDealerItems3.AddLast(ItemType.PlateArmor)
        Item.diamondDealerItems3.AddLast(ItemType.KarateGi)
        Item.diamondDealerItems3.AddLast(ItemType.WingedBoots)
        Item.diamondDealerItems3.AddLast(ItemType.ExplorersBoots)
        Item.diamondDealerItems3.AddLast(ItemType.BootsOfLeaping)
        Item.diamondDealerItems3.AddLast(ItemType.WarDrum)
        Item.diamondDealerItems3.AddLast(ItemType.MinersCap)
        Item.diamondDealerItems3.AddLast(ItemType.Monocle)
        Item.diamondDealerItems3.AddLast(ItemType.Compass)
        Item.diamondDealerItems3.AddLast(ItemType.RingOfCourage)
        Item.diamondDealerItems3.AddLast(ItemType.RingOfLuck)
        Item.diamondDealerItems3.AddLast(ItemType.RingOfWar)
        Item.diamondDealerItems3.AddLast(ItemType.RingOfPeace)
        Item.diamondDealerItems3.AddLast(ItemType.RichesScroll)
        Item.diamondDealerItems3.AddLast(ItemType.ShieldScroll)
        Item.diamondDealerItems3.AddLast(ItemType.ScrollOfNeed)
        Item.diamondDealerItems3.AddLast(ItemType.TitaniumShovel)
        Item.diamondDealerItems3.AddLast(ItemType.Pickaxe)
        Item.diamondDealerItems3.AddLast(ItemType.FireballSpell)
        Item.diamondDealerItems3.AddLast(ItemType.TransmuteSpell)
        Item.diamondDealerItems3.AddLast(ItemType.BrightTorch)
        Item.diamondDealerItems3.AddLast(ItemType.InfernalTorch)
        Item.diamondDealerItems3.AddLast(ItemType.RatFamiliar)
        Item.diamondDealerItems3.AddLast(ItemType.DoveFamiliar)
        Item.diamondDealerItems3.AddLast(ItemType.GlassSlippers)
        Item.diamondDealerItems3.AddLast(ItemType.EarthSpell)
        Item.diamondDealerItems3.AddLast(ItemType.IceSpiritFamiliar)
        Item.diamondDealerItems3.AddLast(ItemType.ShopkeeperFamiliar)
        Item.diamondDealerItems3.AddLast(ItemType.ShieldFamiliar)
        Item.diamondDealerItems3.AddLast(ItemType.RingOfPiercing)
        Item.diamondDealerItems3.AddLast(ItemType.BattleShovel)
        Item.diamondDealerItems3.AddLast(ItemType.PulseSpell)
